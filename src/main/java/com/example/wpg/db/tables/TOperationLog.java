...
public class TOperationLog extends TableImpl<OperationLogRecord> {
    ...
    public TOperationLog where(Condition condition) {
        return new TOperationLog(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public TOperationLog whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public TOperationLog whereNotExists(TableLike<?> select) {
